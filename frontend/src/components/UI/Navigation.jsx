        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              onClick={onUpload}
              className="px-4 py-2 bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 rounded-lg flex items-center gap-2 text-white font-semibold shadow-lg shadow-blue-500/20"
            >
